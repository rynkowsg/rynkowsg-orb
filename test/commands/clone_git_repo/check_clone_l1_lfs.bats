...
@test "check_clone_l1: Content of lfs-file.ltxt is correct" {
...
@test "check_clone_l1: Content of sample-repo-l2/lfs-file.ltxt is correct" {
  content="$(cat "${REPO_DIR}/sample-repo-l2/lfs-file.ltxt")"
  expected_value="This is super large file."
  [ "${expected_value}" == "${content}" ]
}
