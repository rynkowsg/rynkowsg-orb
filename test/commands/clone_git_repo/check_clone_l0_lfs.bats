...
@test "check_clone_l0: Content of lfs-file.txt is correct" {
  content="$(cat "${REPO_DIR}/lfs-file.txt")"
...
@test "check_clone_l0: Content of sample-repo-l1/lfs-file.ltxt is correct" {
  content="$(cat "${REPO_DIR}/sample-repo-l1/lfs-file.ltxt")"
  expected_value="This is super large file."
  [ "${expected_value}" == "${content}" ]
}
...
@test "check_clone_l0: Content of sample-repo-l1/sample-repo-l2/lfs-file.ltxt is correct" {
  content="$(cat "${REPO_DIR}/sample-repo-l1/sample-repo-l2/lfs-file.ltxt")"
  expected_value="This is super large file."
  [ "${expected_value}" == "${content}" ]
}
